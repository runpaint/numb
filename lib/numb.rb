...
libs = %w{abundancy abundant achilles almost_perfect amicable aspiring 
          ...
          highly_abundant hilbert hyperperfect idoneal impolite kaprekar keith 
          k_perfect kynea lucas lucas_carmichael mersenne_prime minimal 
          ...
          prime_count primitive_pseudoperfect primorial pronic proth repunit 
          rhonda self self_descriptive semiperfect semiprime smarandache_wellin
          smith sophie_germain_prime sphenic square square_free sublime 
          sum_of_squares superabundant superperfect triangular trimorphic 
